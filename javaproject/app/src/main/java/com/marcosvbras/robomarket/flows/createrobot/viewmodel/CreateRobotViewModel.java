...
public class CreateRobotViewModel extends BaseViewModel {
    ...
    public boolean isFormValid() {
        if(TextUtils.isEmpty(model.get())) {
            modelFieldError.setErrorResource(R.string.required_field);
            return false;
        }

        if(TextUtils.isEmpty(manufacturer.get())) {
            manufacturerFieldError.setErrorResource(R.string.required_field);
            return false;
        }

        if(TextUtils.isEmpty(price.get())) {
            priceFieldError.setErrorResource(R.string.required_field);
            return false;
        }
